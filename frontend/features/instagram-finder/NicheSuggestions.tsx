      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {niches.map((niche, i) => (
          <motion.div 
            ...
            className="p-8 bg-background border border-outline-variant/5 rounded-3xl hover:border-primary/20 hover:bg-surface-container-high transition-all group/item relative overflow-hidden"
          >
